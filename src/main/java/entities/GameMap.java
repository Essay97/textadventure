...
import setup.serialize.GameMapDeserializer;
 ...
 * them. The map can be generated by a {@link setup.GameMapBuilder} that takes in input a {@link MapBuildStrategy}.
 * By means of these instruments you can generate a map in different ways:
 * <ul>
 *     <li>By parsing a JSON file with {@link JsonMapBuildStrategy}</li>
 *     <li>By parsing a YAML file with {@link YamlMapBuildStrategy}</li>
 *     <li>You can get a dummy map for testing with {@link DummyMapBuildStrategy}</li>
 * </ul>
 * <p>A public constructor is also available but you should really avoid using it, instead implement {@link MapBuildStrategy}
